...
INVENTORY_X=GAME_WIDTH/2-INVENTORY_WIDTH/2*INVENTORY_SCALE;
INVENTORY_Y=GAME_HEIGHT/2-INVENTORY_HEIGHT/2*INVENTORY_SCALE;
...
#region bottom mode
SPR_BOTTOM_INVENTORY=spr_inv_backpack_bottom;
BOTTOM_INVENTORY_WIDTH=sprite_get_width(SPR_BOTTOM_INVENTORY);
BOTTOM_INVENTORY_HEIGHT=sprite_get_height(SPR_BOTTOM_INVENTORY);

BOTTOM_INVENTORY_X=GAME_WIDTH/2-BOTTOM_INVENTORY_WIDTH/2*INVENTORY_SCALE;
BOTTOM_INVENTORY_Y=GAME_HEIGHT-BOTTOM_INVENTORY_HEIGHT*INVENTORY_SCALE;

BOTTOM_SLOTS_X=BOTTOM_INVENTORY_X+11*INVENTORY_SCALE;
BOTTOM_SLOTS_Y=BOTTOM_INVENTORY_Y+11*INVENTORY_SCALE;
